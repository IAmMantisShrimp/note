...
public class ImageVerificationCode {
    ...
    public void output(BufferedImage image) throws IOException                  //将验证码图片写出的方法
    {
        OutputStream out = new FileOutputStream("F:\\Java\\PracticeProject\\20220515个人运动管理平台\\20230218练习\\demo\\src\\main\\resources\\static\\image\\a.jpg");  /// 将图片生成到 e盘下面
     ...
     * @return
     */
    public String getImageBinary(BufferedImage image){
        return "data:image/jpg;base64,"+ImageConvertByte.getImageBinary(image);
    }
    public static void main(String[] args) throws IOException {
        ...
        imageVerificationCode.output(image);
        System.out.println(imageVerificationCode.getText());
        //String imageBinary = ImageConvertByte.getImageBinary(image);
        //System.out.println(imageBinary);
        String imageBinary1 = imageVerificationCode.getImageBinary(image);
